...
let handler = async (m, { conn }) => {
  ...
  let dann = '6285786539008@s.whatsapp.net'
  let a = await conn.profilePictureUrl(conn.user.jid, 'image').catch((_) => "https://telegra.ph/file/057b8dff2f6ba7d4553ae.jpg")
  let b = await conn.profilePictureUrl(owner[0]+'@s.whatsapp.net', 'image').catch((_) => "https://telegra.ph/file/b13c833380613e8cf08da.jpg")
...
*Ada ± 370 Fitur Aktif*`,
  ...
  footerText: 'JIKA MAU ORDER SILAHKAN CHAT KONTAK OWNER',
  }},{})
