...
let handler = async (m, { conn, usedPrefix }) => {
   ...
   // let name = m.fromMe ? conn.user : conn.contacts[m.sender]
    ...
    let pancingan = user.pancing
 // let name = global.db.data.users.[m.sender].name
    let sortedbalance = Object.entries(global.db.data.users).sort((a, b) => b[1].balance - a[1].balance)
    ...
    let usersbalance = sortedbalance.map(v => v[0])
    ...
    let ages = 'https://telegra.ph/file/171a415bb75f025f8db7a.jpg'
    let str = `
───「 乂 STATS 乂 」───
[ 🐱 ] Name: ${name}
[ 💉 ] Health: ${health}
...
───「 乂 EQUIPMENT 乂 」───
[ 🥼 ] Armor: ${armor == 0 ? 'Tidak Punya' : '' || armor == 1 ? 'Leather Armor' : '' || armor == 2 ? 'Iron Armor' : '' || armor == 3 ? 'Gold Armor' : '' || armor == 4 ? 'Diamond Armor' : '' || armor == 5 ? 'Netherite Armor' : '' || armor > 6 ? 'Hacker Armor' : ''}
[ 🗡️ ] Sword: ${sword == 0 ? 'Tidak Punya' : '' || sword == 1 ? 'Leather sword' : '' || sword == 2 ? 'Iron sword' : '' || sword == 3 ? 'Gold sword' : '' || sword == 4 ? 'Diamond sword' : '' || sword == 5 ? 'Netherite sword' : '' || sword > 6 ? 'Hacker Sword' : ''}
[ ⛏️ ] Pickaxe: ${pickaxe == 0 ? 'Tidak Punya' : '' || pickaxe == 1 ? 'Leather pickaxe' : '' || pickaxe == 2 ? 'Iron pickaxe' : '' || pickaxe == 3 ? 'Gold pickaxe' : '' || pickaxe == 4 ? 'Diamond pickaxe' : '' || pickaxe == 5 ? 'Netherite pickaxe' : '' || pickaxe > 6 ? 'Hacker Pickaxe' : ''}
[ 🎣 ] Pancingan: ${pancingan == 0 ? 'Tidak Punya' : '' || pancingan == 1 ? 'Level 1' : '' || pancingan == 2 ? 'Level 2' : '' || pancingan == 3 ? 'Level 3' : '' || pancingan == 4 ? 'Level 4' : '' || pancingan == 5 ? 'Level 5' : '' || pancingan > 6 ? 'Level MAX' : ''}
...
body: 'This Is Your inventory',
thumbnailUrl: 'https://i.ibb.co/dj8LX9r/image.jpg',
