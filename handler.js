			...
			for (let name in global.plugins) {
				...
				if ((usedPrefix = (match[0] || '')[0])) {
					...
					if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
						this.reply(m.chat, `🐱 Your limit runs out, please buy through ${usedPrefix}buylimit, or contact the owner MakeMeow +6282161429908`, m)
						continue
					}
				...
				if (chat.welcome) {
					...
					for (let user of participants) {
						...
						try {
							...
							let wel = 'https://cdn.jsdelivr.net/gh/SazumiVicky/MakeMeow-Storage@main/20230530_105029.jpg';
							let lea = 'https://cdn.jsdelivr.net/gh/SazumiVicky/MakeMeow-Storage@main/20230530_105100.jpg';
...
global.dfail = (type, m, conn) => {
	let msg = {
		...
		unreg: 'Hi user ,To continue using the bot, please register first, Example:\n\n╭─ •「 F.A BOTZ MD 」\n│ ◦ *Manual* : *.register fahrul.18*\n╰──── •',
